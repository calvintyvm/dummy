    ...
    <div className="footerContainer">
      ...
      <div className="footerTextContainer">
        ...
        <div className="footerAddress">
          ...
          <span className="otherAddressInfo">{"kelowna bc".toUpperCase()}</span>
        </div>
        ...
        <div className="terms">
          <span>
            This is not an offering for sale. Such offering can only be made by
            way of disclosure statements. Coco House is developed by Konnect
            Developments. Renderings, sketches, plans and finishes are
